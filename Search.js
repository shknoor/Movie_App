...
import { Button, createMuiTheme, createTheme, Tab, Tabs, TextField, ThemeProvider, } from "@material-ui/core";
import "./search.css";
...
const Search = () => {
  ...
  const fetchSearch = async () => {
    try {
       const{data}= await axios.get(`https://api.themoviedb.org/3/search/${type ? "tv" : "movie"}?api_key=${api_key
